...
export class Initial1619119623329 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "comment" ("comment_id" SERIAL NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "comment" character varying NOT NULL, "tweetTweetId" integer, CONSTRAINT "PK_6a9f9bf1cf9a09107d3224a0e9a" PRIMARY KEY ("comment_id"))`
        );
        await queryRunner.query(
