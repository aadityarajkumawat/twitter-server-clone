...
exports.newMig1621869818441 = void 0;
class newMig1621869818441 {
    constructor() {
        this.name = "newMig1621869818441";
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "like" ("like_id" SERIAL NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer NOT NULL, "like_on_id" integer NOT NULL, "like_on" character varying NOT NULL, "tweetTweetId" integer, CONSTRAINT "PK_90999e6c2872ea84c11682a1762" PRIMARY KEY ("like_id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "comment" ("comment_id" SERIAL NOT NULL, "comment_on_id" integer NOT NULL, "comment_on" character varying NOT NULL, "comment_by" integer NOT NULL, "commentMsg" character varying NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "username" character varying NOT NULL, "name" character varying NOT NULL, "profileImg" character varying NOT NULL, "likes" integer NOT NULL, "comments" integer NOT NULL, "img" character varying NOT NULL, "tweetTweetId" integer, CONSTRAINT "PK_6a9f9bf1cf9a09107d3224a0e9a" PRIMARY KEY ("comment_id"))`);
...
exports.newMig1621869818441 = newMig1621869818441;
//# sourceMappingURL=1621869818441-new_mig.js.map